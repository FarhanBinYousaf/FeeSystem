<?php
	...
	if(isset($_POST['login']))
	{
		...
		$StuPassword = $_POST['upassword'];
		$LoginQuery = "SELECT * FROM `student` WHERE `Name`='$StuName' && `password`='$StuPassword'";
		$QueryRunner = mysqli_query($conn,$LoginQuery);
		if($FName==$StuName && $Fpasswod==$StuPassword)
		{

			$_SESSION['Name'] = $FName;
			$_SESSION['Regno'] = $RegNo;
 			$_SESSION['user']	= true;
			header("location:student_fee_profile.php");
		}
	}
			...
			<div class="card-body">
				<form method="POST">
					<div class="input-group form-group">
						...
						<input type="text" name="stuName" class="form-control" placeholder="Name">
