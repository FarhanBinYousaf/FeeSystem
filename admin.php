    ...
    <div class="row ">
      <div class="col-md-4 my-4">
        <div class="card" style="width: 16rem;">
          <div class="card-body">
            <div class="card-title text-center">
              <a href="student_profile.php" class="text-white"><i class="fas fa-users fa-7x"></i><br>
        ...
        <div class="card" style="width: 16rem;">
          <div class="card-body">
            <div class="card-title text-center">
              <a href=""  class="text-white"><i class="fas fa-users fa-7x"></i><br>
       ...
       <div class="col-md-4 my-4">
        <div class="card" style="width: 16rem;">
          <div class="card-body">
            <div class="card-title text-center">
              <a href="manage_fee.php"  class="text-white"><i class="fas fa-users fa-7x"></i><br>
                <h3>Manage Fee</h3>
              </a>
             </div>
          </div>
