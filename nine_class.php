    ...
    <div class="row ">
      <div class="col-md-6 my-4">
        <div class="card" style="width: 16rem;">
          <div class="card-body">
            <div class="card-title text-center">
              <a href="add_9th_profile.php" class="text-white"><i class="fas fa-user-plus fa-7x"></i><br><br>
                <h3>Add Profile</h3>
              </a>
             </div>
          </div>
        ...
        <div class="card" style="width: 16rem;">
          <div class="card-body">
            <div class="card-title text-center">
              <a href="manage_9th_profile.php"  class="text-white"><i class="fas fa-user-edit fa-7x"></i><br><br>
